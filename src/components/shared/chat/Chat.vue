                ...
                <div v-else>
                  <div v-for="chat in chats" v-bind:key="chat.id">
                    <a-row class="hero" style="margin-bottom: 1rem">
                      <a @click="fetchmessages('jessica')" style="color: black">
                        <a-col span="4">
...
export default {
  ...
  methods: {
    ...
    sendMessage() {
      ...
      axios.post('http://localhost:9000/remote/v1/projects/chat/send_message/dennis/' +
          'jessica/sendbird_group_channel_64617788_0a254aec2957b80c11d1cb411040f5277dd01074/', params).then(function (response) {
